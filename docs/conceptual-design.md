...
![Development, Deployment and Runtime](images/development-deployment-and-runtime.jpg "Development, Deployment and Runtime")
...
- Develop and test on local pc.
  ...
  - If during the development you added some new data, you can run the backup container locally, and then manually trigger restore on production vm, and you will have what you added locally also in production.
- Build docker images and push to docker hub
  - Once you did all your modifications, you probably changed the docker images as well. You need to push them to docker hub. 
...
- Deploy to production
  ...
  - If during the deployment you also did changes on the database data, or website data, and did a backup from local. You can manually trigger restore, to get the backup and restore it to production. 
- Test production after deploy


## Future thoughts
### Deployments
- In the future if needed, all this local flow can be easily migrated to a github/gitlab pipeline. 
- Test environments can be added, as an intermediary layer, and a proper deployment pipeline can be build.
